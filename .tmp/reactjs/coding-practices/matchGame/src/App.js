...
class App extends Component {
  ...
  render() {
    const {isTrue, score, imgUrl, category, time} = this.state
        ...
        <div className="content">
          {!isTrue && (
            <div className="div1">
              ...
              <ul className="tab-items">
                {tabsList.map(eachImg => (
                  <li key={eachImg.tabId}>
                    <button
                      type="button"
                      className={`tab-button ${
                        category === eachImg.tabId ? 'highlight-text' : ''
                      }`}
                      onClick={() => this.clickTab(eachImg.tabId)}
                    >
                      {eachImg.displayText}
                    </button>
                  </li>
              ...
              <ul className="thumbnail-Imgs">
                {thumbNailsList.map(eachValue => (
                  <li key={eachValue.id}>
                    <button
                      type="button"
                      className="button"
                      onClick={() => this.onClickImage(eachValue.thumbnailUrl)}
                    >
                      <img
          ...
          {isTrue && (
            <div className="div2">
              ...
              <button className="button" type="button" onClick={this.playAgain}>
                <img
